...
export function Navbar() {
  ...
  const navLinks = [{name:'Works',href:'/works'},{name:'About',href:'/about'},{name:'Services',href:'/#services',hash:true}];

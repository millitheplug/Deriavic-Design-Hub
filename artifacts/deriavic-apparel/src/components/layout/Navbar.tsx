...
export function Navbar() {
  ...
  // Same-page hash anchors (like "Services") aren't routes wouter's Link/base
  // can resolve — render those as plain anchors prefixed with BASE_URL so they
  // still work correctly when the app is deployed under a subpath (e.g. GitHub Pages).
